...
private &
  ...
  mpmul, mpmuld, mpmuld40, mpnint, mpnorm, mpnpwr, mpnrtr, mpoutw, mpoutw2, &
  mprandr, mproun, mpsqrt, mpsub, mpmqc,  mpqmc, mpfftcr, mpfftrc, mpfft1, &
  mpfft2, mpfft3, mpinifft, mplconv, mpmulx, mpdivx
...
private &
  mpberner,  mpbesseljr, mperfr, mperfcf, mpgammar, mpincgammar, mpzetar, &
  mpzetaemr
