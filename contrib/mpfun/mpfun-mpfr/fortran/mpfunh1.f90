...
private &
  ...
  mp_gamma, mp_gammainc, mp_hypot, mp_initvr, mp_initvz, mp_inpr, &
  mp_inpz, mp_log, mp_log_gamma, mp_log2, mp_max, mp_min, mp_mod, &
  mp_nrt, mp_outr, mp_outz, mp_pi, mp_polylog, mp_prodd, mp_qtor, &
  mp_quotd, mp_rand, mp_readr1, mp_readr2, mp_readr3, mp_readr4, &
  mp_readr5, mp_readz1, mp_readz2, mp_readz3, mp_readz4, mp_readz5, &
  mp_rtod, mp_rtoq, mp_rtom, mp_rtor, mp_rtoz, mp_setwp, mp_sign, &
  mp_sin, mp_sinh, mp_sqrt, mp_tan, mp_tanh, mp_wprec, mp_wprecz, &
  mp_writer, mp_writez, mp_zeta, mp_zetaem, mp_ztodc, mp_ztor, &
  mp_ztor2, mp_ztoz, mp_ztozm
...
!>>
    ...
    call mpfr_set (mp_ztozm%mpc(1), za%mpc(1), %val(mprnd))
    call mpfr_set (mp_ztozm%mpc(l2+1), za%mpc(l1+1), %val(mprnd))
    return
  end function
